...
public class UpdateMovieHandler implements HttpAction {
    private final MovieService movieService;
    private final Gson gson;

    public UpdateMovieHandler(MovieService movieService, Gson gson) {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        try {
            ...
            // CHANGED HERE: Pass the full 'movie' domain object directly
            // instead of unpacking its fields and converting the ID to a string.

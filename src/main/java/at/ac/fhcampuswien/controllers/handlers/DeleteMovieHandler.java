...
public class DeleteMovieHandler implements HttpAction {
    private final MovieService movieService;
    private final Gson gson;

    public DeleteMovieHandler(MovieService movieService, Gson gson) {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        try {
            ...
            // CHANGED HERE: Pass the full 'movie' object directly to the service layer
